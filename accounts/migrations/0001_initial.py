    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('manager', 'مدیر کل فروش'), ('supervisor', 'سوپروایزر'), ('expert', 'کارشناس')], default='expert', max_length=20, verbose_name='نقش')),
                ...
                ('supervisor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='team_members', to=settings.AUTH_USER_MODEL, verbose_name='سوپروایزر')),
